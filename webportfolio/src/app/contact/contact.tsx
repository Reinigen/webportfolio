export default function Contact(){
    return(
        <div id="contact-form" className="me-md-5 p-md-5 me-5 my-5 vh-75">
            ...
            <form action="https://api.web3forms.com/submit" method="POST" className="text-start pe-5 me-5 mb-5">
